...
public class MemberController {
    ...
    public String index(@RequestParam(value = "p", required = false) Integer curPage,
        ...
        if (StringUtils.hasText(search_field_name) || StringUtils.hasText(search_field_value) ||
                StringUtils.hasText(search_sort) || StringUtils.hasText(search_state)) {
    ...
    public String editPage(Long member_id, Model model, HttpServletRequest request) {
